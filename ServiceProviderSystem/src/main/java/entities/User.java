...
public class User implements Serializable {
    ...
    public static void showMainMenu(Scanner scanner, DataManager dataManager) {
        while (true) {
            ...
            try {
                ...
                switch (choice) {
                    case 1 -> loginUser(scanner, dataManager);
                    case 2 -> registerCustomer(scanner, dataManager);
                    case 3 -> registerProvider(scanner, dataManager);
                    case 4 -> dataManager.viewAllServiceTypes();
                    case 5 -> dataManager.viewTopProviders();
                    case 6 -> {
    ...
    private static void registerCustomer(Scanner scanner, DataManager dataManager) {
        ...
        try {
            ...
            System.out.print("Enter Password: "); String password = scanner.nextLine().trim();
            System.out.print("Enter Phone: ");    String phone    = scanner.nextLine().trim();
            System.out.print("Enter First Name: "); String firstName = scanner.nextLine().trim();
            System.out.print("Enter Last Name: ");  String lastName  = scanner.nextLine().trim();
            System.out.print("Enter Address: ");    String address   = scanner.nextLine().trim();
    ...
    private static void registerProvider(Scanner scanner, DataManager dataManager) {
        ...
        try {
            ...
            System.out.print("Enter Password: ");     String password    = scanner.nextLine().trim();
            System.out.print("Enter Phone: ");        String phone       = scanner.nextLine().trim();
            System.out.print("Enter Business Name: ");String businessName= scanner.nextLine().trim();
            ...
            for (ServiceType type : dataManager.getServiceTypes()) {
                if (type.getServiceTypeId() == serviceTypeId) { selectedType = type; break; }
            }
